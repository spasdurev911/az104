...
|---|---------|--------|--------|
| 1 | [Compute & Identity Management](./project-1-compute-identity/) | VMs, RBAC, Key Vault, Policy, Cost Management | ⏳ Upcoming |
| 2 | [Networking & Storage](./project-2-networking-storage/) | VNet, NSG, Storage Accounts, ARM Templates | 🔄 In Progress |
